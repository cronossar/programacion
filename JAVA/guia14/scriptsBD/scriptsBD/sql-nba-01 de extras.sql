...
select nombre from equipos where lower(conferencia) = 'east' order by nombre;
select nombre, procedencia from jugadores where procedencia = 'Argentina';

-- 5. Mostrar los equipos donde su ciudad empieza con la letra ‘c’, ordenados por nombre.
select ciudad from equipos where ciudad like 'c%' order by nombre;
